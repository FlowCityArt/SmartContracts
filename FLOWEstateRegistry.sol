...
contract FLOWEstateRegistry is Migratable, IFLOWEstateRegistry, ERC721Token, ERC721Receiver, Ownable, EstateStorage {
 ...
 /**
  ...
  function initialize(
    ...
    public
    isInitializer("FLOWEstateRegistry", "0.0.2")
  {
